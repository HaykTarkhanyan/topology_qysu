...
% 7.11
\item Դիտարկենք $\R^n$, $n \ge 1$ կոորդինատային տարածությունը \hyperref[ch7ex3]{օրինակ 3}-ում \linebreak սահ\-մանված $\rho(x,y) = \sqrt{(x_1-y_1)^2+(x_2-y_2)^2+\dots+(x_n-y_n)^2}$ մետրիկով։ Ապացուցեք, որ այդ մետրիկային տարածությունում ամեն մի $\mathcal{S}(a, r)$ սֆերա հանդիսանում է տվյալ $\mathcal{D}(a, r)$ գնդի եզր՝ ըստ թեմա 6-ում սահմանված ենթա\-բազմության եզր հասկացության։
