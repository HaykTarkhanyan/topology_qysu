...
\begin{hint}
Դիտարկեք $f: (a, b) \to (c, d), \ f(x) = c + \dfrac{d-c}{b-a}(x-a)$ ան\-ընդ\-հատ արտապատկերումը և, օգտվելով 1, 2 օրինակներից, կիրառեք թեորեմ 6-ը թեմա 11-ում:
\end{hint}
...
\par Ընտրելով $f_i: A_i A_{i+1} \to B_i B_{i+1},\ i=1, 2, \dots, 5$ և $f_6: A_6 A_1 \to B_6 B_1$ հոմե\-ո\-մոր\-ֆիզմներ՝ կառուցեք հոմեոմորֆիզմ շրջանագծի և «երեքնուկի» միջև օգտվե\-լով թեորեմ 3-ից:
\end{hint}
...
\begin{hint}
Օգտվեք թեմա 1-ի օրինակ 9-ում բերված արտապատկերումից։
\end{hint}
