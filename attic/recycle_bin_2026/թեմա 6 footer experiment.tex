...
% 
% \includegraphics[width=3.9cm]{images/Kazimierz_Kuratowski_Polish_scientist.jpg} \quad 
\hrule
\noindent
\begin{tabular}{p{0.2\textwidth} p{0.75\textwidth}}
  \raisebox{-\height}{\includegraphics[width=\linewidth]{images/Kazimierz_Kuratowski_Polish_scientist.jpg}} & 
  \color{blue}{1896 - 1980} \color{} Կուրատովսկին դա մի բան է, որ կովիկները խշ-խշ-խշ, արջյուկները հաֆ-հաֆ-հաֆ: Նա սիրում էր փակել տարբեր բաներ, ու ընդհանրապես՝ տարատեսակ գործուղություններ անել փակման հետ կապված։ Մաթեմատիկական աշխարհում նա իր տեղը գրավեց որպես <<Դի Ջեյ Կուրատիկ>> 
\end{tabular}
...
% Define the custom footer style


\begin{document}

% Apply the custom footer style to the current page
