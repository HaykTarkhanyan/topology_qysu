...
\end{example}
Դիցուք $I$-ն բազմություն է, որի ամեն մի $i\in I$ տարրի համապատասխանեցված է որևէ $X$ բազմություն։ Այս $X$ բազմություններից կազմված բազմությունը (բազ\-մութ\-յունների ընտանիքը) նշանակվում է $\left\{ X_i; \,  i \in I \right\}$ և կոչվում է \textbf{բազմությունների ինդեքսավոր\-ված ընտանիք}։ Այստեղ $I$-ն կոչվում է \textbf{ինդեքսների բազմություն}։
...
\par Այս օրինակում որպես ինդեքսների բազմություն հանդես եկավ շրջանագծի բոլոր կետերից կազմված $S$ բազմությունը։
\begin{center}
...
Մասնավոր դեպքում, երբ $\{X_a; \, i \in I\}$ ընտանիքի բոլոր $X$ տարրերը միևնույն $X$ բազմության ենթաբազմություններ են՝ $X_i\subset X$, դե Մորգանի $\eqref{eq:1.1}$ բանաձևերն ընդունում են մտապահման հեշտ ձև․ միավորման լրացումը լրացումների հատումն է, իսկ հատման լրացումը լրացումների միավորումն է։
...
\begin{align*}
f(X_1\cup  X_2)=f(X_1)&\cup  f(X_2), \quad f(X_2),\ f(X_1\cap X_2)\subset {f(X_1)\cap f(X_2)},\\
& {f(X_1)\setminus f(X_2)\subset f(X_1\setminus X_2)}։
\end{align*}
\end{theorem}
\label{թեորեմ 1:1}
\begin{proof}
Ապացուցենք դրանցից երկրորդը՝
...
% ավելացված
\begin{example}
Ամբողջ թվերի $\Z$ բազմության $f : \Z \rightarrow \Z$ արտապատկերումը՝ սահմանված $f(n)=n+1$ բանաձևով, փոխմիարժեք է (հիմնավորե՛լ) և տարբեր է $\nuynakan_\Z$ նույնական արտապատկերումից։
\end{example}
