...
\begin{example}
Դիտարկենք $\R^2$ հարթության մեջ այն բոլոր ուղիղներից կազմված $L$ բազմությունը, որոնք գտնվում են կոորդինատների $0$ սկզբնակետից $1$ միավոր հեռավորության վրա։ Ցույց տանք, թե ինչպես կարելի է ինդեքսավորել $L$-ը։ Նկա\-տենք, որ այդ բազմության ամեն մի տարր (ուղիղ) ունի ճիշտ մի ընդհանուր կետ $S=\left\{ (x; y) \mid x^2+y^2=1 \right\}$ շրջանագծի հետ (շոշափման կետը)։ Նշանակելով $l_s$-ով շրջանագծի $s\in S$ կետով տարված շոշափողը, կարող ենք $L$ բազմությունը ներ\-կա\-յացնել որպես բազմությունների ինդեքսավորված ընտանիք՝ $L=\left\{l_i ; i\in S\right\}$։ \red{Վստահ չեմ որ փոքրատառ i ինկատի ուներ}
