...
% 11.1
\item Ունենք $f : X \to Y$ անընդհատ արտապատկերում և $A \subset X$ են\-թա\-բազ\-մու\-թյուն։ Չհիմնվելով \hyperref[ch11thm1]{թեորեմ 1}-ի վրա՝ ապացուցեք, որ $f$-ի սահմանափակումը $A$֊ի վրա անընդհատ է։
...
% 11.3
\item Նկարագրեք թվային ուղղի սովորական տոպոլոգիայից ա) ամբողջ թվերի $\Z$ են\-թա\-բազ\-մու\-թյան վրա, բ) ռացիոնալ թվերի $\Q$ ենթաբազմության վրա մակ\-ած\-ված տոպոլոգիաները:
...
\par Ստորև 11.8-11.11 խնդիրներում կորերը և մակերևույթները դիտարկվում են հա\-մա\-պա\-տաս\-խա\-նա\-բար $(\R^2, \text{սովոր․})$ և $(\R^3, \text{սովոր․})$ տարածություններից մա\-կ\-ած\-ված տոպոլոգիաներով։ Ապացուցեք․
...
\par Ստորև 11.13-11.14 խնդիրներում $[a, b]$, $[a, b)$ հատվածները դիտարկվում են թվային ուղղի սովորական տոպոլոգիայից մակածված տոպոլոգիաներով։
