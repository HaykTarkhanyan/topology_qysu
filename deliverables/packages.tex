...
\usepackage{graphicx}
\graphicspath{ {./images_for_internal_reference/} }
...
\usepackage{nicefrac}
\usepackage{mathrsfs} % Ձեռագիր փոքրատառ պոչիկով s
...
\newcommand*\inlinegraphicslower[1]{%
  \settototalheight\myheight{Xygp}%
  \settodepth\mydepth{Xygp}%
  \raisebox{-\mydepth-3pt}{{#1}}%
}
...
\newtheorem*{hetevanq8_sa}{Հետևանք թեորեմ 8-ից}
...
\newtheorem*{hetevanq6_7}{Հետևանք թեորեմներ 6-ից և 7-ից}
...
\newtheorem{note_counter}{Դիտողություն}
...
% Proof environment without heading ("Ապացուցում:")
\makeatletter
